...
namespace DAL.Migrations
{
    ...
    [Migration("20220728193326_addingIdentityFeature")]
    partial class addingIdentityFeature
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Entities.CustomerList", b =>
                {
                    b.HasOne("Models.Entities.Bank", "Bank")
                        .WithOne("CustomerList")
                        .HasForeignKey("Models.Entities.CustomerList", "BankId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
